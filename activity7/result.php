...
$results = array_filter($listings, function ($job) use ($keyword) {
  return strcasecmp($job['location'], $keyword) == 0;
})
?>
...
<body class="bg-gray-100">
  <header class="bg-blue-500 text-white p-4">
    <div class="container mx-auto">
      <h1 class="text-3xl font-semibold">Job Listings in <?php echo $keyword; ?></h1>
    </div>
  </header>
  <div class="container mx-auto p-4 mt-4">
    ...
    <?php if (count($results)>0): ?>
      ...
      <?php endforeach; ?>
      <center>
        <a href="main.php" style="color: blue; text-decoration: underline; cursor: pointer">SEARCH AGAIN</a>
      </center>
    <?php else: ?>
      <center>
